...
export type BlockProps = Record<string | symbol, unknown>;
...
export abstract class Block {
    ...
    protected constructor(propsAndChildrenAndLists: BlockProps, tagName = 'div') {
        ...
        this.lists = lists;
        this.props = this._makePropsProxy({ ...props as BlockProps, __id: this._id });
    ...
    setProps(newProps: Partial<BlockProps>): void {
        if (!newProps) {
            return;
        }
